...
export const FREE_QUESTION_COUNT = QUESTION_CATALOG.filter((question) => !question.isPlus).length;
export const PLUS_QUESTION_COUNT = QUESTION_CATALOG.filter((question) => question.isPlus).length;
