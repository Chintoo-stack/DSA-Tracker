...
export function AuthPanel() {
  ...
  return (
    <div className="hero-card">
      <h3>{identityAvailable ? "Sign in to keep your streak" : "Try Ember instantly"}</h3>
      {identityAvailable ? (
        ...
        <p className="muted">
          Identity is enabled after the first Netlify deploy. Until then, jump into a local demo — progress stays in this
          browser.
        </p>
      )}
